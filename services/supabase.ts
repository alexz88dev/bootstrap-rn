...
export const SupabaseService = {
  ...
  // Edge Functions
  async processCutout(imageUrl: string, userId: string): Promise<string | null> {
  ...
  async grantIAPPurchase(receiptData: string, productId: string, userId: string): Promise<boolean> {
  ...
  async spendCredits(userId: string, styleId: string): Promise<{ success: boolean; balance_after?: number }> {
